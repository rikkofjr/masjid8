...
class KasPengeluaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            ->addColumn('action',function($row){
                $btn = '<a href="'.route('adminkas-pengeluaran.edit', $row->id).'" data-toggle="tooltip" class="btn btn-primary btn-sm deleteProduct"><i class="far fa-eye text-white"></i></a>';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminkas-pengeluaran.index');
    }
