...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{route('adminqurban.create')}}"> <i class="fas fa-edit"></i> Tambah Data</a>
	</div>
</div>
@endsection
        ...
        <script>
            $(function(){
                var table = $('#tableKambing').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('adminApiQurbanKambingByThisYear') }}",
                    columns : [
            ...
            $(function(){
                var table = $('#tableSapi').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('adminApiQurbanSapiByThisYear') }}",
                    columns : [
                        {data:'created_at',name:'created_at', orderable : false},
                        {data:'nomor_hewan',name:'nomor_hewan', orderable : false},
                        {data: 'atas_nama', name: 'atas_nama', orderable: false},
