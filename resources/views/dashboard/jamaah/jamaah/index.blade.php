...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('adminalamat-jamaah.create') }}"> <i class="fas fa-pencil-alt"></i> Tambah Jamaah</a>
	</div>
