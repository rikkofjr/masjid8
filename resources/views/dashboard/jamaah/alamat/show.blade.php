...
<div class="section-header">
	...
	<div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('adminalamat-jamaah.index') }}"> <i class="fas fa-arrow-left"></i> Back</a>
	</div>
</div>
@endsection
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
                ...
                <a target="_blank"href="{{route('adminPrintKeluarga', $alamatjamaah->id)}}" class="btn btn-primary">
                    Print <i class="fas fa-print"></i>
                </a>
                <a href="{{route('adminalamat-jamaah.edit', $alamatjamaah->id)}}" class="btn btn-success">
                    edit <i class="fas fa-edit"></i>
                </a>
                @can('outsource-delete')
                <div class="section-header-breadcrumb">
                    <form method="POST" action="{{route('adminSoftDeleteKeluarga', $alamatjamaah->id)}}">
                       @csrf
                       <input name="_method" type="hidden" value="DELETE">
...
<div class="modal fade bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                {{ Form::open(array('route' => 'admindata-jamaah.store'))}}
