...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{route('adminalamat-jamaah.create')}}"> <i class="fas fa-edit"></i> Tambah Data</a>
	</div>
</div>
@endsection
        ...
        <script>
            $(function(){
                var table = $('#tableInternal').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('adminApiAllJamaahInternal') }}",
                    columns : [
            ...
            $(function(){
                var table = $('#tableExternal').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('adminApiAllJamaahExternal') }}",
                    columns : [
                        {data:'DT_RowIndex',name:'DT_RowIndex'},
                        {data: 'nama_pemilik', name: 'nama_pemilik'},
                        {data: 'alamat', name: 'alamat'},
