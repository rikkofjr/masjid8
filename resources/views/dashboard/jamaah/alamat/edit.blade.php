...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('adminalamat-jamaah.show', $aj->id) }}"> <i class="fas fa-arrow-left"></i> Back</a>
	</div>
</div>
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
            {{ Form::model($aj, array('route' => array('adminalamat-jamaah.update', $aj->id), 'method' => 'PUT')) }}
                <div class="row">
