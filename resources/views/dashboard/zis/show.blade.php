        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered table-stripped">
                    ...
                    <tr>
                        <td colspan="3">Nama Lain : {!! nl2br(e($zis->nama_lain)) !!}</td>
                    </tr>
                    <tr>
                ...
                <a href="{{route('adminzis.edit', $zis->id)}}" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                ...
                @can('outsource-delete')
                    <form method="POST" action="{{route('adminSoftDeleteZis', $zis->id)}}">
                       @csrf
