...
@section('pageTitle')
    Laporan Pengeluaran Tahun {{$nowMasehi}}
@endsection
...
<div class="section-header">
    <h1>Laporan Pengeluaran Tahun {{$nowMasehi}}</h1>
    <div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{ route('adminkas-pengeluaran.create') }}"> <i class="fas fa-pencil"></i> Tambah Data</a>
	</div>
                    ...
                    <table class="table table-striped" id="data-table">
                        <thead>
                            <tr>
                                ...
                                <th name="Pengeluaran">Jumlah Uang</th>
        ...
        <script>
            $(function(){
                var table = $('#data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('adminkas-pengeluaran.index') }}",
                    columns : [
