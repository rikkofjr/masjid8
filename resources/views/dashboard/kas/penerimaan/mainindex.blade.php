...
<div class="section-header">
	...
	<div class="section-header-breadcrumb">
		<a class="btn btn-icon icon-left btn-primary" href="{{route('adminkas-penerimaan.create')}}"> <i class="fas fa-plus"></i> Tambah Data</a>
	</div>
</div>
@endsection
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var dataTable = $('#kasPenerimaan').DataTable({
                    ...
                    // scrollX: true,
                    "order": [[ 0, "desc" ]],
                    ajax: '{{ route('adminApiAllKasPenerimaan') }}',
                    columns: [
                        {data: 'id', name: 'id'},
